...
cred = {                           # You can hard code authentication information in the following lines
        "CLIENT_ID" :  "60cc6422d6d93f4a332ba9f3",         #   Your client ID from Netatmo app registration at http://dev.netatmo.com/dev/listapps
        "CLIENT_SECRET" : "0ihaipiUDdl89vVIxDrEvvTUI2pEOUvfOBa",      #   Your client app secret   '     '
        "USERNAME" : "fs7866@gmail.com",           #   Your netatmo account username
        "PASSWORD" : "Higesan3＃"            #   Your netatmo account password
        }
