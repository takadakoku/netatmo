...
cred = {                           # You can hard code authentication information in the following lines
        "CLIENT_ID" :  "ここにCLIENT_IDを入力",         #   Your client ID from Netatmo app registration at http://dev.netatmo.com/dev/listapps
        "CLIENT_SECRET" : "ここにCLIENT_SECRETを入力",      #   Your client app secret   '     '
        "USERNAME" : "アカウントのユーザーネーム",           #   Your netatmo account username
        "PASSWORD" : "アカウントのパスワード"            #   Your netatmo account password
        }
